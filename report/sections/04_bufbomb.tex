...
介绍本次实验的目的意义、目标、要求及安排等。正式撰写时，应依据 \path{experiments/lab_bufbomb/requirement_summary.md} 补充，不得脱离原始实验要求。
...
\begin{enumerate}[label=\arabic*.]
    ...
    \item \textbf{实验过程：}依据 \path{experiments/lab_bufbomb/evidence/commands.md}、\path{experiments/lab_bufbomb/outputs/} 和截图索引描述真实操作过程。
